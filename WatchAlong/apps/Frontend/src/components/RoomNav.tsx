...
export default function RoomNav({isPlaying, setIsOpen,isOpen, roomName, roomId}: {isPlaying: isPlayingType, setIsOpen: (isOpen: boolean) => void, isOpen: boolean, roomName: string, roomId: string | undefined}) {
  return (
