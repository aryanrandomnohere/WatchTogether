    ...
    return (
        <div className="bg-gray-900 min-h-screen flex flex-col items-center p-4 sm:items-start">
            <div className="w-full sm:w-1/2 lg:w-1/3">
                <input
                    className="w-full rounded-lg mt-8 py-2 px-3 font-medium bg-white bg-opacity-20 text-zinc-300 placeholder-gray-500 focus:outline-none"
            ...
            <div className="w-full grid grid-cols-4 grid-rows-5 sm:grid-cols-3 gap-4 mt-6">
                <div className="col-span-3 row-span-4 sm:col-span-2 bg-gray-800 rounded-lg p-4">
                    <Series imdbId={id} />
                </div>
            </div>
        </div>
