...
export default function Notification({request}:{request:requests}) {
  ...
  return (
    <div className="text-white py-1.5 px-2 rounded-md hover:bg-slate-600 hover:bg-opacity-10 ">
      <div><div className="flex items-center justify-between gap-3">
        <div className="flex gap-2"><Avatar r="req" name={request.fromUsername} /><div className="flex flex-col font-bold">
